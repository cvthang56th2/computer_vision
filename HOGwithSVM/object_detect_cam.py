...
class ObjectController(Frame):
    ...
    def __init__(self, parent=None):                            # if not a frame
        ...
        self.detector = HOGDetector(detector_filename='corgi_model100.svm')
    ...
    def run(self):
        ...
        while not self.stopEvent.is_set():
            ...
            rects = self.detector.predict(gray)
            ...
            if len(rects) > 0:
                for (i, rect) in enumerate(rects):
                    (x, y, xb, yb) = rect
                    cv2.rectangle(vis, (x, y), (xb, yb), (0, 255, 0), 2)
...
if __name__ == '__main__':
    ...
    csc = ObjectController(appWindow)
